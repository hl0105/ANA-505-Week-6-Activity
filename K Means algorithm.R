...
#Firstly, check the data, understand the data structure and attribute.
#Secondly, change variables with class attribute to variables with suitable attribute by normalizing them.
#Thirdly, apply the K-means clustering algorithm.
#  our model has achieved 88.7% accuracy!
