...
#Firstly, split data into training data and test data. 
#caret lib can help us split data, then build the model on the training data.
# 97.8% cases were correctly classified. 
