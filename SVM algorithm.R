...
#Firstly, we need to explore data, and then create the SVM model by using svm statement. 
#Secondly, we need to look at our parameters using ggpairs statement. 
#Thirdly, choosing the best parameters and have them in our svm model.
#SVM accuracy:97.3%
